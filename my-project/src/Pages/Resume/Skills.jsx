...
const Skills = () => {
  return (
    ...
    >
      <div className=" container mx-auto px-5 md:px-10 lg:px-14 w-full lgl:w-1/2">
        <div className="py-12 font-titleFont flex flex-col gap-4">
          <h6 className="text-2xl md:text-2xl font-bold">Development Skill</h6>
        </div>
        <div className="flex flex-col gap-6">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">CSS (tailwindCSS)</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
